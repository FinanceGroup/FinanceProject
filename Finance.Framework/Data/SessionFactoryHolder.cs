...
//using Augmentum.XGenos.Data.Providers;
//using Augmentum.XGenos.Environment;
//using Augmentum.XGenos.Environment.Configuration;
//using Augmentum.XGenos.Environment.ShellBuilders.Models;
//using Augmentum.XGenos.FileSystems.AppData;
//using Augmentum.XGenos.Localization;
...
namespace Finance.Framework.Data {
    ...
    //            if (persistentClass.EntityName.StartsWith("Augmentum.XGenos.ContentManagement.Records.")) {
